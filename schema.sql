...
--
-- Name: gig_work_is_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: hours_per_week_of_gig_work_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: in_the_last_12_months_generic_frequency_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: in_the_last_12_months_number_of_times_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: argyle_driver_activities; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.argyle_driver_activities (
    id text NOT NULL,
    account text,
    employer text,
    created_at text,
    ...
    status text,
    type text,
    all_timestamps_request_at numeric,
    all_timestamps_pickup_at numeric,
    all_timestamps_dropoff_at numeric,
    all_timestamps_cancel_at numeric,
    all_timestamps_shift_start numeric,
    all_timestamps_shift_end numeric,
    all_timestamps_break_start numeric,
    all_timestamps_break_end numeric,
    all_timestamps_breaks text,
    all_datetimes_request_at text,
    all_datetimes_accept_at text,
    all_datetimes_pickup_at text,
    all_datetimes_dropoff_at text,
    all_datetimes_cancel_at text,
    all_datetimes_shift_start numeric,
    all_datetimes_shift_end numeric,
    all_datetimes_break_start numeric,
    all_datetimes_break_end numeric,
    all_datetimes_breaks text,
    duration numeric,
    timezone text,
    earning_type text,
...
--
-- Name: driver_demographic_survey; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.driver_demographic_survey (
    id integer NOT NULL,
    user_id uuid NOT NULL,
    age integer,
    gender text,
...
ALTER TABLE public.driver_demographic_survey OWNER TO postgres;

--
-- Name: driver_demographic_survey_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.driver_demographic_survey_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.driver_demographic_survey_id_seq OWNER TO postgres;

--
-- Name: driver_demographic_survey_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.driver_demographic_survey_id_seq OWNED BY public.driver_demographic_survey.id;


--
-- Name: driver_survey_1; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.driver_survey_1 (
    id integer NOT NULL,
    user_id uuid NOT NULL,
    estimate integer,
    fair integer,
    ...
    consents_to_more_surveys boolean DEFAULT true NOT NULL,
...
ALTER TABLE public.driver_survey_1 OWNER TO postgres;

--
-- Name: driver_survey_1_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.driver_survey_1_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.driver_survey_1_id_seq OWNER TO postgres;

--
-- Name: driver_survey_1_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.driver_survey_1_id_seq OWNED BY public.driver_survey_1.id;
...
--
-- Name: rider_fares; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.rider_fares (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    rider uuid,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    ride_price bigint DEFAULT '0'::bigint NOT NULL,
    ride_time timestamp with time zone DEFAULT now() NOT NULL,
    ride_app text DEFAULT 'UBER'::text NOT NULL,
    linked_driver_fare text,
    screenshot_path text,
    driver_id uuid
);


ALTER TABLE public.rider_fares OWNER TO postgres;
...
--
-- Name: user_meta_data; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.user_meta_data AS
 SELECT users.id AS user_id,
    ...
    (users.raw_user_meta_data ->> 'argyle_account'::text) AS argyle_account,
    (users.raw_user_meta_data ->> 'argyle_user'::text) AS argyle_user,
    (users.raw_user_meta_data ->> 'phone'::text) AS phone
   FROM auth.users users
  WHERE (users.raw_user_meta_data IS NOT NULL);


ALTER VIEW public.user_meta_data OWNER TO postgres;
...
--
-- Name: driver_demographic_survey id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_demographic_survey ALTER COLUMN id SET DEFAULT nextval('public.driver_demographic_survey_id_seq'::regclass);


--
-- Name: driver_survey_1 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_survey_1 ALTER COLUMN id SET DEFAULT nextval('public.driver_survey_1_id_seq'::regclass);
...
--
-- Name: argyle_driver_activities argyle_driver_activities_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: driver_demographic_survey driver_demographic_survey_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_demographic_survey
    ADD CONSTRAINT driver_demographic_survey_pkey PRIMARY KEY (id);


--
-- Name: driver_survey_1 driver_survey_1_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_survey_1
...
--
-- Name: rider_fares rider_fares_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rider_fares
    ADD CONSTRAINT rider_fares_pkey PRIMARY KEY (id);


--
-- Name: rider_fares rider_fares_screenshot_url_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rider_fares
    ADD CONSTRAINT rider_fares_screenshot_url_key UNIQUE (screenshot_path);
...
--
-- Name: sms_messages unique_phone_number_message_message_template_id; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sms_messages
    ADD CONSTRAINT unique_phone_number_message_message_template_id UNIQUE (phone_number, message_template_id);


--
-- Name: sms_messages unique_phone_number_message_scheduled_to_send_at; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: driver_demographic_survey update_driver_demographic_survey_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_driver_demographic_survey_modtime BEFORE UPDATE ON public.driver_demographic_survey FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: feedback update_feedback_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_feedback_modtime BEFORE UPDATE ON public.feedback FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: sms_messages update_sms_messages_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_sms_messages_modtime BEFORE UPDATE ON public.sms_messages FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: argyle_driver_activities argyle_driver_activities_linked_rider_fare_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.argyle_driver_activities
    ADD CONSTRAINT argyle_driver_activities_linked_rider_fare_fkey FOREIGN KEY (linked_rider_fare) REFERENCES public.rider_fares(id);


--
-- Name: argyle_driver_activities argyle_driver_activities_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.argyle_driver_activities
    ADD CONSTRAINT argyle_driver_activities_user_fkey FOREIGN KEY ("user") REFERENCES auth.users(id) ON DELETE SET NULL;


--
-- Name: driver_demographic_survey driver_demographic_survey_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_demographic_survey
    ADD CONSTRAINT driver_demographic_survey_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL NOT VALID;


--
-- Name: driver_survey_1 driver_survey_1_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.driver_survey_1
    ADD CONSTRAINT driver_survey_1_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL;


--
-- Name: feedback feedback_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.feedback
    ADD CONSTRAINT feedback_user_fkey FOREIGN KEY ("user") REFERENCES auth.users(id);


--
-- Name: rider_fares rider_fares_driver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rider_fares
    ADD CONSTRAINT rider_fares_driver_id_fkey FOREIGN KEY (driver_id) REFERENCES auth.users(id);


--
-- Name: rider_fares rider_fares_linked_driver_fare_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rider_fares
    ADD CONSTRAINT rider_fares_linked_driver_fare_fkey FOREIGN KEY (linked_driver_fare) REFERENCES public.argyle_driver_activities(id);


--
-- Name: rider_fares rider_fares_rider_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rider_fares
    ADD CONSTRAINT rider_fares_rider_fkey FOREIGN KEY (rider) REFERENCES auth.users(id);
...
--
-- Name: driver_survey_1 Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for authenticated users only" ON public.driver_survey_1 FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: driver_survey_1 Enable read access for matching users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for matching users" ON public.driver_survey_1 FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: argyle_driver_activities Enable update for users based on user ID; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: argyle_driver_activities Read access to only matching users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: argyle_driver_activities; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.argyle_driver_activities ENABLE ROW LEVEL SECURITY;

--
-- Name: driver_survey_1; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.driver_survey_1 ENABLE ROW LEVEL SECURITY;
...
--
-- Name: rider_fares; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.rider_fares ENABLE ROW LEVEL SECURITY;
...
--
-- Name: supabase_realtime argyle_driver_activities; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.argyle_driver_activities;


--
-- Name: supabase_realtime driver_survey_1; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.driver_survey_1;


--
-- Name: supabase_realtime sms_messages; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.sms_messages;
...
--
-- Name: TABLE argyle_driver_activities; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE driver_demographic_survey; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.driver_demographic_survey TO anon;
GRANT ALL ON TABLE public.driver_demographic_survey TO authenticated;
GRANT ALL ON TABLE public.driver_demographic_survey TO service_role;


--
-- Name: SEQUENCE driver_demographic_survey_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE driver_survey_1; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.driver_survey_1 TO anon;
GRANT ALL ON TABLE public.driver_survey_1 TO authenticated;
GRANT ALL ON TABLE public.driver_survey_1 TO service_role;


--
-- Name: SEQUENCE driver_survey_1_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE rider_fares; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.rider_fares TO anon;
GRANT ALL ON TABLE public.rider_fares TO authenticated;
GRANT ALL ON TABLE public.rider_fares TO service_role;
...
--
-- Name: TABLE user_meta_data; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.user_meta_data TO anon;
GRANT ALL ON TABLE public.user_meta_data TO authenticated;
GRANT ALL ON TABLE public.user_meta_data TO service_role;
