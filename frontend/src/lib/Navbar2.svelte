<!-- https://github.com/consultingninja/svelteTemplateProject/blob/main/src/lib/Navbar.svelte -->
...
<nav class={clicked? 'navbar-clicked' : 'navbar'}>
    <div class="menu-icon">
        <div class="icon-wrapper">
          <button on:click={handleClick} on:keypress={handleClick}>
    ...
    {#each data.links as link}
        ...
        <div class={clicked? 'navbar-item-clicked' : 'navbar-item'}>
            <a class='link-text' href={link.url} on:click={resetClick} on:keypress={resetClick}>{link.linkText}</a>
        </div>
        {/if}
    {/each}
