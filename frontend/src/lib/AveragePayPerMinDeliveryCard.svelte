<script>
    ...
    let average_pay_per_minute_delivery = 'Loading...'; // Placeholder text while fetching data
    let aggregate_pay_per_minute_delivery = 'Loading...'; // Placeholder for the last updated time
